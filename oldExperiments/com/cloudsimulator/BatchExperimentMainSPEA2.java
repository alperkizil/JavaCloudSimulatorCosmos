 ...
 */
public class BatchExperimentMainSPEA2 {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            BatchExperimentMainSPEA2 app = new BatchExperimentMainSPEA2();
            app.run();
        });
    }
    ...
    private void singleRun(ExperimentConfiguration config) {
        ...
        // Step 5: Assign tasks to VMs using SPEA2 multi-objective optimization
        NSGA2Configuration nsga2Config = NSGA2Configuration.builder()
                ...
                .build();
        MOEA_SPEA2TaskSchedulingStrategy taskStrategy = new MOEA_SPEA2TaskSchedulingStrategy(nsga2Config);
