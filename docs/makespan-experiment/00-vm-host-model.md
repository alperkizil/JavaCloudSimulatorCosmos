...
**THIS REPORT IS A WORK ORDER, NOT JUST A BRIEFING. ACT ON IT.**
...
- **DO NOT ASK FOR PERMISSION ON EVERY CHANGE.** THE FIXES IN §6 AND §9 ARE PRE-AUTHORIZED.
  MAKE THEM, COMPILE, COMMIT, AND PUSH WITHOUT STOPPING FOR APPROVAL ON EACH ONE. ONLY PAUSE
  IF A DECISION IS GENUINELY AMBIGUOUS OR HARD TO REVERSE.
